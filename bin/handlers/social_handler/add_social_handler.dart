...
addSocialHandler(Request req) async {
  try {
    final Map<String, dynamic> body = jsonDecode(await req.readAsString());
    checkBody(keys: ['user_name', 'social'], body: body);
    ...
    await SupaBaseIntegration().insertToTable(tableName: 'social', body: body);

    return Response.ok("social has been added successfully");
